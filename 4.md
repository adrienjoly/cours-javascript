...
- [JavaScript Kit](http://www.javascriptkit.com/jsref/) (en Anglais, moins à jour, mais plus concis)
...
> Vous aurez probablement besoin d'utiliser la fonction [parseInt()](https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Objets_globaux/parseInt) pour convertir des chaînes de caractères en véritables nombres.
