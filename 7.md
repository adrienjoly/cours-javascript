...
- `parentNode` est le noeud/élément HTML parent de l'élément, et
- `children` est un tableau de noeuds HTML (éléments et/ou noeud textuel), enfants directs de l'élément.
