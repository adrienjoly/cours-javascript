...
### Exercice: développer un composant simple

Pour mettre en pratique cette partie du chapitre, développer un des trois composants suivants, et fournir une page contenant une intégration d'exemple de ce composant.
