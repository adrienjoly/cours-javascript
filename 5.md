...
```html
<p id="premier">texte visible</p>
<p id="second">ce texte devrait être caché</p>
```
...
Les solutions les plus élégantes seront présentées en cours, selon les critères suivants:

- esthétique du rendu,
- ergonomie / flexibilité d'usage du filtrage,
- concision du code.
