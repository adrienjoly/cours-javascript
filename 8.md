...
1. Effectuer une requête `GET` avec `XMLHttpRequest` (<a href="./slides/13-ajax/index.html" target="_blank">Slides du TP</a>)
  - Exercice: afficher la météo de la ville de l'utilisateur
2. Effectuer une requête `POST` avec `XMLHttpRequest` (<a href="./slides/14-ajax2/index.html" target="_blank">Slides du TP</a>)
