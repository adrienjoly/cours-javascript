...
APIs simples:
  - Adresse IP: [httpbin.org/ip](https://httpbin.org/ip) (HTTP / HTTPS)
  - Heure: [time.jsontest.com](http://time.jsontest.com/) (*HTTP Only*)
  - Utilisateur: [jsonplaceholder.typicode.com/users/1](https://jsonplaceholder.typicode.com/users/1) (HTTP / HTTPS)
...
TODO: parler des restrictions d'origine (ex: jsfiddle)
