...
1. Effectuer une requête `GET` avec `XMLHttpRequest` ([Slides du TP](./slides/13-ajax))
  - Exercice: afficher la météo de la ville de l'utilisateur
2. Effectuer une requête `POST` avec `XMLHttpRequest` ([Slides du TP](./slides/14-ajax2))
