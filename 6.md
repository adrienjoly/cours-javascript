...
1. Création d'un composant Web simple (<a href="./slides/10-composants/index.html" target="_blank">Slides du TP</a>)
  - Exercice: Accordéon / Carousel / Galerie vidéo
2. Composant Web multi-instances et POO (<a href="./slides/11-poo/index.html" target="_blank">Slides du TP</a>)
