...
1. Algorithmes
2. Boucles `for` ([Slides du TP](https://cours-javascript-eemi-2016-2017.github.io/js-slides/03-algo))
  - Application: FizzBuzz
  - Application: Devine le nombre
3. Fonctions ([Slides du TP](https://cours-javascript-eemi-2016-2017.github.io/js-slides/05-fonctions))
