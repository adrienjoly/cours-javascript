...
1. Algorithmes
2. Boucles `for` (<a href="./slides/03-algo/index.html" target="_blank">Slides du TP</a>)
  - Application: FizzBuzz
  - Application: Devine le nombre
3. Fonctions (<a href="./slides/05-fonctions/index.html" target="_blank">Slides du TP</a>)
