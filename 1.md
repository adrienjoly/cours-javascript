...
### Exercice: Votre propre chat-bot

À vous de concevoir et implémenter votre propre chat-bot !

Cet exercice se passe en deux étapes:
1. Dessiner un arbre représentant 10 questions reconnues par votre chat-bot, ainsi que les réponses associées.
2. 
