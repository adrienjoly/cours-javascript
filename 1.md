...
> - [jsconsole.com](https://jsconsole.com/) est ma préférée, car la plus simple;
> - [repl.it](https://repl.it/languages/javascript) et [glot.io](https://glot.io/new/javascript) permettent d'éditer son code de manière un peu plus confortable mais ne conserve pas d'historique de vos instructions;
> - [runkit](https://runkit.com/), cumule les avantages des autres, mais il est plus complexe à utiliser.
...
1) Créez la variables suivantes:
...
if (monNombre === 1) {
    ...
    'monNombre est supérieur à 1';
} else {
    'monNombre n\'est ni égal à 1, ni supérieur à 1';
}
```
...
- et sinon, afficher `Désolé, je ne vous ai pas compris...`.
